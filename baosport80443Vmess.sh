...
rm -rf /etc/XrayR/baosport.crt
rm -rf /etc/XrayR/baosport.key
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertDomain: "vn.baosport.me" # Domain to cert
        CertFile: /etc/XrayR/cert/techzpn.crt # Provided if the CertMode is file
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        CertMode: file # Option about how to get certificate: none, file, http, tls, dns. Choose "none" will forcedly disable the tls config.
        CertDomain: "vn.baosport.me" # Domain to cert
        CertFile: /etc/XrayR/cert/baosport.crt # Provided if the CertMode is file
