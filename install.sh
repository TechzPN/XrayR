...
install_XrayR() {
    ...
    if [[ ! -f /etc/XrayR/config.yml ]]; then
        ...
        echo -e ""
        echo -e "  Cài đặt mới, vui lòng tham khảo hướng dẫn trước：https://github.com/TechzPN/XrayR，Định cấu hình nội dung cần thiết"
	echo ""
    else
	    ...
	    echo "  nếu không khởi động được, định dạng cấu hình có thể đã bị thay đổi, vui lòng liên hệ：https://zalo.me/0397333616 để được hộ trợ"
        fi
    fi
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/TechzPN/XrayR/main/XrayRvip.sh
